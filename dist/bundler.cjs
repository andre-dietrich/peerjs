...
class $a8347a6741c5df8a$export$89e6bb5ad64bf4a {
    ...
    /** Returns a PeerConnection object set up correctly (for data, media). */ startConnection(options = {}) {
        ...
        if (this.connection.type === (0, $1a7e7edd560505fc$export$3157d57b4135e3bc).Media) {
    ...
    cleanup() {
        ...
        try {
            ...
            (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).warn("Error stopping tracks", err);
        }
        ...
        if (dataChannel) {
            try {
                ...
                (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).warn("Error closing data channel", err);
            }
            // Clear reference
        ...
        if (peerConnection.signalingState !== "closed") try {
            ...
            (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).warn("Error closing PeerConnection", err);
        }
            ...
            try {
                ...
                if (this.connection.options.sdpTransform) try {
                    ...
                    if (typeof transformResult === "string" && transformResult.length > 0) {
                        ...
                        (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("Applied sdpTransform to offer");
                    } else (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).warn("sdpTransform returned invalid SDP, using original");
                } catch (transformError) {
                    provider.emitError((0, $1a7e7edd560505fc$export$9547aaa2e39030ff).WebRTC, transformError);
                    (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).error("Error in sdpTransform function:", transformError);
                }
        ...
        try {
            ...
            try {
                ...
                if (this.connection.options.sdpTransform) try {
                    ...
                    if (typeof transformResult === "string" && transformResult.length > 0) {
                        processedSdp = transformResult;
                        (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log("Applied sdpTransform to answer");
                    } else (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).warn("sdpTransform returned invalid SDP, using original");
                } catch (transformError) {
                    provider.emitError((0, $1a7e7edd560505fc$export$9547aaa2e39030ff).WebRTC, transformError);
                    (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).error("Error in sdpTransform function:", transformError);
    ...
    /** Handle an SDP. */ async handleSDP(type, sdp) {
        ...
        try {
            ...
            (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).log(`Set remote description ${type} successfully`);
            if (type === "OFFER") await this._makeAnswer();
        } catch (err) {
            const errorMessage = `Failed to set remote ${type} SDP: ${err.message}`;
            (0, $df9d8b89ee908b8b$export$2e2bcd8739ae039).error(errorMessage, err);
            // Categorize error for better handling
            if (err.name === "InvalidStateError") provider.emitError((0, $1a7e7edd560505fc$export$9547aaa2e39030ff).WebRTC, `Invalid signaling state: ${peerConnection.signalingState}. ${errorMessage}`);
            else if (err.name === "InvalidAccessError") provider.emitError((0, $1a7e7edd560505fc$export$9547aaa2e39030ff).WebRTC, `Invalid SDP format or unsupported configuration. ${errorMessage}`);
            else provider.emitError((0, $1a7e7edd560505fc$export$9547aaa2e39030ff).WebRTC, errorMessage);
            this.connection.close();
        }
    }
