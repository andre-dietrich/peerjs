...
class $b82fb8fc0514bfc1$export$89e6bb5ad64bf4a {
    ...
    cleanup() {
        ...
        try {
            ...
            (0, $257947e92926277a$export$2e2bcd8739ae039).warn("Error stopping tracks", err);
        }
        ...
        if (dataChannel) {
            try {
                ...
                (0, $257947e92926277a$export$2e2bcd8739ae039).warn("Error closing data channel", err);
            }
            // Clear reference
        ...
        if (peerConnection.signalingState !== "closed") try {
            ...
            (0, $257947e92926277a$export$2e2bcd8739ae039).warn("Error closing PeerConnection", err);
        }
            ...
            try {
                ...
                if (this.connection.options.sdpTransform) try {
                    ...
                    if (typeof transformResult === "string" && transformResult.length > 0) {
                        ...
                        (0, $257947e92926277a$export$2e2bcd8739ae039).log("Applied sdpTransform to offer");
                    } else (0, $257947e92926277a$export$2e2bcd8739ae039).warn("sdpTransform returned invalid SDP, using original");
                } catch (transformError) {
                    provider.emitError((0, $78455e22dea96b8c$export$9547aaa2e39030ff).WebRTC, transformError);
                    (0, $257947e92926277a$export$2e2bcd8739ae039).error("Error in sdpTransform function:", transformError);
                }
        ...
        try {
            ...
            try {
                ...
                if (this.connection.options.sdpTransform) try {
                    ...
                    if (typeof transformResult === "string" && transformResult.length > 0) {
                        processedSdp = transformResult;
                        (0, $257947e92926277a$export$2e2bcd8739ae039).log("Applied sdpTransform to answer");
                    } else (0, $257947e92926277a$export$2e2bcd8739ae039).warn("sdpTransform returned invalid SDP, using original");
                } catch (transformError) {
                    provider.emitError((0, $78455e22dea96b8c$export$9547aaa2e39030ff).WebRTC, transformError);
                    (0, $257947e92926277a$export$2e2bcd8739ae039).error("Error in sdpTransform function:", transformError);
    ...
    /** Handle an SDP. */ async handleSDP(type, sdp) {
        ...
        try {
            ...
            (0, $257947e92926277a$export$2e2bcd8739ae039).log(`Set remote description ${type} successfully`);
            if (type === "OFFER") await this._makeAnswer();
        } catch (err) {
            const errorMessage = `Failed to set remote ${type} SDP: ${err.message}`;
            (0, $257947e92926277a$export$2e2bcd8739ae039).error(errorMessage, err);
            // Categorize error for better handling
            if (err.name === "InvalidStateError") provider.emitError((0, $78455e22dea96b8c$export$9547aaa2e39030ff).WebRTC, `Invalid signaling state: ${peerConnection.signalingState}. ${errorMessage}`);
            else if (err.name === "InvalidAccessError") provider.emitError((0, $78455e22dea96b8c$export$9547aaa2e39030ff).WebRTC, `Invalid SDP format or unsupported configuration. ${errorMessage}`);
            else provider.emitError((0, $78455e22dea96b8c$export$9547aaa2e39030ff).WebRTC, errorMessage);
            this.connection.close();
        }
    }
